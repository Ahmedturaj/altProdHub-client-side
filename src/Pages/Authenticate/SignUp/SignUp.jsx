...
const SignUp = () => {
    ...
    const handleSignUp = async (e) => {
        ...
        try {
            ...
            const result = await signUp(name, photo, email, password);
            ...
            const response = await axios.post('http://localhost:5000/users', topUsers);
            ...
            <div className="container flex items-center justify-center min-h-screen px-6 mx-auto">
                <form onSubmit={handleSignUp} className="w-full max-w-md">
                    ...
                    <div className="relative flex items-center mt-4">
                        ...
                        <input type={showPassword ? "text" : "password"} className="block w-full px-10 py-3  border rounded-lg  dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Password" name='password' />
